...
**Changes**: Add loaded_libraries parameter
...
**File**: `crates/djls-ide/src/completions.rs`
**Changes**: Update `generate_template_completions` and `handle_completion`
...
**Changes**: Pass loaded_libraries to completion handler
