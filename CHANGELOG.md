...
- **Internal**: Made normal tests independent of corpus downloads with checked-in source fixtures, gated corpus sweeps behind `corpus-tests`, and made corpus validation use each project's environment.
