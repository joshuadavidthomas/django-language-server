...
The LSP server. This is the crate that wires everything together at runtime. The protocol plumbing — JSON-RPC transport, message framing, request dispatch — comes from [tower-lsp-server](https://github.com/tower-lsp-community/tower-lsp-server); this crate implements the request handlers on top.
