...
1. Basic tag structure (type, closing tags, intermediates)
2. Simple argument validation
3. Support for variable placeholders
4. Clear distinction between required and optional arguments

The schema is designed to be extensible for future additions like:
