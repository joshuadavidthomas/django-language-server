...
",
    ...
    fn analyze(source: &str) -> crate::python::types::TagRule {
        let parsed = parse_module(source).expect("valid Python");
        let module = parsed.into_syntax();
        let func = module
            .body
        ...
        crate::python::analysis::analyze_compile_function(&func)
    }

    fn analyze_func(func: &StmtFunctionDef) -> crate::python::types::TagRule {
        crate::python::analysis::analyze_compile_function(func)
    }
...
"#,
    ...
    fn match_partialdef_pattern() {
        ...
        assert!(
            rule.arg_constraints
                .contains(&crate::python::types::ArgumentCountConstraint::OneOf(vec![
                    2, 3
                ])),
    ...
    fn match_partial_exact() {
        ...
        assert!(
            rule.arg_constraints
                .contains(&crate::python::types::ArgumentCountConstraint::Exact(2)),
...
"#,
        ...
        assert!(
            rule.arg_constraints
                .contains(&crate::python::types::ArgumentCountConstraint::Min(1)),
            "expected Min(1), got {:?}",
            rule.arg_constraints
        );
    }
...
"#,
        ...
        assert!(
            !rule
                .arg_constraints
                .iter()
                .any(|c| matches!(c, crate::python::types::ArgumentCountConstraint::Min(_))),
...
"#,
        ...
        assert!(
            !rule.arg_constraints.iter().any(
                |c| matches!(c, crate::python::types::ArgumentCountConstraint::Min(m) if *m > 0)
            ),
