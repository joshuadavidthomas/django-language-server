...
pub(crate) use module_facts::ModuleFactsBuilder;
pub(crate) use module_facts::ModuleImport;
pub(crate) use module_facts::ModuleImportResolver;
pub(crate) use module_facts::ModuleSource;
pub(crate) use module_facts::Truthiness;
pub(crate) use module_facts::degrade_touched_bodies;
pub(crate) use module_facts::pattern_bound_names;
pub(crate) use module_facts::walk_if;
pub(crate) use module_facts::walk_match;
pub(crate) use module_facts::walk_try;
