...
| [018](018-distinguish-not-in-installed-apps.md) | Restore not-in-INSTALLED_APPS diagnostics from an environment library scan | P2 | M | 007, 008 (009 rec., 015 soft) | IN PROGRESS (source complete at `83a40294` + `1504d527` + `98136c83`, review approved 2026-06-12; awaiting push/PR) |
...
- **2026-06-11 (Plan 016 PR #670 — review verdict and the corpus
  ...
  check: no `#[path]` test includes under any `src/`. The vendoring pass
